...
do_create   = 1;  % create new features/component
do_trim     = 1;  % trim each feature
do_meas     = 0;  % measure output of each feature in isolation
do_test     = 1;  % test output of each feature in full VAD
do_final    = 0;  % do final output testing
do_resume   = 0;  % resume trimming/testing from last point
