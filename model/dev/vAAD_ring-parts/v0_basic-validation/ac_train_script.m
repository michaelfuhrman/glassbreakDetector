...
rate					= 0.08;
learns				= [.05,			.1,			.3,			.8,			2,				4,				10,				20,				40];
learn_thresh	= [0.4e-3,	.3e-3,	.2e-3,	0.1e-3, 0.075e-3, 0.05e-3,	0.04e-3,	0.03e-3,	0.02e-3];
...
io.in{end+1}	= struct('pos',  'rms_0',      'neg',  'mid',  'ch', 3);
io.in{end+1}	= struct('pos',  'rms_0_min',  'neg',  'mid',  'ch', 4);
io.in{end+1}	= struct('pos',  'rms_1',      'neg',  'mid',  'ch', 5);
io.in{end+1}	= struct('pos',  'rms_1_min',  'neg',  'mid',  'ch', 6);
